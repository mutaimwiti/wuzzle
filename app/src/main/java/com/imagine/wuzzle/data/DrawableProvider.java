...
public class DrawableProvider {
	...
	public Drawable getRectWithCustomSize(String s, String s1) {
		String leftText = s;
		String rightText = s1;
	...
	public Drawable getRectWithAnimation(String label) {
		TextDrawable.IBuilder builder = TextDrawable.builder().rect();

		AnimationDrawable animationDrawable = new AnimationDrawable();
		int c = label.length();
		for (int i = 0; i < c; i++) {
			TextDrawable frame = builder.build(String.valueOf(label.charAt(i)),
	...
	public Drawable getRoundWithCustomFont(String text) {
